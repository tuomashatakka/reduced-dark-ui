...
import { fetchFontLists, appendFontDependency } from './core/fonts'
...
class Theme {
  ...
  activate (state) {
    window.appendFontDependency = appendFontDependency
...
const commands = {
        ...
        'reduced-dark-ui:add-icon-stylesheets': () => provideIconStylesheets(),
