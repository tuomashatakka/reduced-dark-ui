'use babel'
import { getHaystack, getIcons, updateIcons, clearIcons, makeIcon, ICON_CLASS_NAME } from './core/icons'
...
export const setPanelIcons = (q='left') => {
  ...
  panels.forEach(panel => {
    ...
    let packageClass = resolvePanelPackage(panel)
    ...
    parentElement.insertBefore(
      iconNode,
      node)
    parentElement.classList.add(packageClass)
