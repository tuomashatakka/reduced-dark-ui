'use babel'
import { writeFile, statSync, mkdirSync, readFileSync }  from 'fs'
...
export default class ConfigManagerAnew extends Emitter {
  ...
  writeConfigurationToFile ({ name, content, path }) {
    setImmediate(() =>
      writeFile(path, translateToLessVariables(content), 'utf8',
...
function initStorage () {
  // if (this.configured)
  //   return true
  // let stylesPath          = resolve(`${__dirname}/../../../styles`)
